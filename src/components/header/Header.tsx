...
const Header: React.FC<HeaderProps> = ({ onToggleSidebar }) => {
  ...
  useEffect(() => {
    ...
    const handleStorageChange = (e: StorageEvent) => {
      if (
        e.key === "teams_user_status" ||
        e.key === "teams_user_status_color"
      ) {
        checkUserStatus();
      }
    };
    ...
    <header className="h-[48px] bg-[#ebebeb] flex items-center px-2 sm:px-4 relative">
        ...
        <div className="flex-grow flex justify-center">
          <div className="flex-grow flex justify-center">
            ...
            >
              <SearchBox
                placeholder={
                  isSmallScreen ? "Search" : "Search Microsoft Teams"
                }
                styles={{
                  root: {
                    width: "100%",
      ...
      <div
        className={`flex items-center ${
          isSmallScreen ? "space-x-1" : "space-x-2 sm:space-x-4"
        } ml-1 sm:ml-4`}
      >
        ...
        <div className="relative">
          <button
            ...
            className={`${
              isSmallScreen ? "p-0.5" : "p-1 sm:p-2"
            } hover:bg-[#f5f5f5] rounded-full transition-colors`}
            onMouseEnter={() => {
