...
const ChatPage = () => {
  ...
  const handleChatOptionsClick = (id: number, e: React.MouseEvent) => {
    e.stopPropagation();
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-1 h-[calc(100vh-60px)] overflow-hidden">
        ...
        {(!isMobile || (isMobile && showSidebar)) && (
          <div className={`${isMobile ? 'w-full' : 'w-[320px]'} border-r border-[#e1e1e1] flex flex-col bg-white h-full`}>
                ...
                <div className="p-2">
                  <div className="flex items-center px-2 py-1">
                    <div className="flex items-center text-gray-600 text-sm font-medium">
                      <span>Recent</span>
                      <ChevronDown24Regular className="ml-1" fontSize={16} />
                    </div>
                  </div>
                    ...
                    >
                      ...
                      {hoveredChatId === chat.id && (
                        <IconButton
                          ...
                          onClick={(e) => handleChatOptionsClick(chat.id, e)}
                        >
                          <MoreHorizontal20Regular />
                        </IconButton>
                      )}
            ...
            {chats.length > 0 && showSyncBanner && (
              <div className="p-3 border-t border-[#e1e1e1] bg-gray-50">
                <div className="flex items-center justify-between mb-3 text-sm">
                  <div>Find more people by syncing from your phone or other sources.</div>
                  <div className="flex">
        ...
        {showNewChat && (!isMobile || (isMobile && !showSidebar)) && (
          <div className="flex-1 flex flex-col bg-white overflow-hidden">
            ...
            <div className="flex items-center p-3 border-b border-[#e1e1e1]">
              ...
              <div className="flex flex-col flex-1">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <IconButton
                    ariaLabel={showGroupNameField ? "Hide group name" : "Show group name"}
                    onClick={toggleGroupNameField}
                  >
                    {showGroupNameField ? <ChevronUp24Regular /> : <ChevronDown24Regular />}
                  </IconButton>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-4">
              ...
              <h2 className="text-xl font-semibold mb-1">You're starting a new conversation</h2>
            ...
            <div className="border-t border-[#e1e1e1] p-3">
              <div className="flex items-end rounded-md border border-[#e1e1e1] overflow-hidden">
                <TextField
                  ...
                  styles={{
                    root: { margin: '0', width: '100%' },
                    fieldGroup: { background: 'transparent', padding: '8px 8px 0 8px' }
                  }}
                />
                ...
                <div className="flex items-center border-none p-2 ml-auto">
                  <div className="flex items-center mr-2">
                    <IconButton 
                      ariaLabel="Emoji" 
                      styles={{
                        root: { color: '#616161', height: '32px', width: '32px' }
                      }}
                    >
                      <EmojiRegular />
                    </IconButton>
